...
# ACDS 22.4 94 linux 2023.03.08.08:35:36
...
TOP_LEVEL_NAME="ed_sim.ed_sim"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/nfs/site/disks/swbld_archive_3/acds/22.4/94/linux64/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [ed_sim::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
...
set ELAB_OPTIONS ""
append ELAB_OPTIONS [ed_sim::get_elab_options $SIMULATOR_TOOL_BITNESS]
puts "ELAB_OPTIONS+=\"$ELAB_OPTIONS\""
set SIM_OPTIONS ""
append SIM_OPTIONS [ed_sim::get_sim_options $SIMULATOR_TOOL_BITNESS]
...
source $QSYS_SIMDIR/common/xcelium_files.tcl
set libraries [dict merge $libraries [ed_sim::get_design_libraries]]
...
mkdir -p ./libraries/fourteennm_hssi_ver/
...
mkdir -p ./libraries/fourteennm_hssi/
...
source $QSYS_SIMDIR/common/xcelium_files.tcl
set memory_files [concat $memory_files [ed_sim::get_memory_files "$QSYS_SIMDIR"]]
...
if [ $SKIP_DEV_COM -eq 0 ]; then
  ...
  xmvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QUARTUS_INSTALL_DIR/eda/sim_lib/ct1_hssi_atoms.sv"                  -work fourteennm_hssi_ver
  xmvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QUARTUS_INSTALL_DIR/eda/sim_lib/ct1_hip_atoms.sv"                   -work fourteennm_hssi_ver
  ...
  xmvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QUARTUS_INSTALL_DIR/eda/sim_lib/ct1_hssi_atoms_ncrypt.sv"           -work fourteennm_hssi    
  xmvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QUARTUS_INSTALL_DIR/eda/sim_lib/ct1_hip_atoms_ncrypt.sv"            -work fourteennm_hssi    
  xmvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QUARTUS_INSTALL_DIR/eda/sim_lib/ct1_hssi_components.vhd"            -work fourteennm_hssi    
  xmvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QUARTUS_INSTALL_DIR/eda/sim_lib/ct1_hssi_atoms.vhd"                 -work fourteennm_hssi    
  xmvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QUARTUS_INSTALL_DIR/eda/sim_lib/ct1_hip_components.vhd"             -work fourteennm_hssi    
  xmvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QUARTUS_INSTALL_DIR/eda/sim_lib/ct1_hip_atoms.vhd"                  -work fourteennm_hssi    
fi
...
source $QSYS_SIMDIR/common/xcelium_files.tcl
set design_files [dict merge $design_files [ed_sim::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set files [list]
source $QSYS_SIMDIR/common/xcelium_files.tcl
set files [concat $files [ed_sim::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
