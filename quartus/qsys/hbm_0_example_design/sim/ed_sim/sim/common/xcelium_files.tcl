source [file join [file dirname [info script]] ./../../../ip/ed_sim/ed_sim_hbm_only_reset_source/sim/common/xcelium_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/ed_sim/ed_sim_mem/sim/common/xcelium_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/ed_synth/ed_synth_reset_release_ip/sim/common/xcelium_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/ed_synth/ed_synth_tg0_1/sim/common/xcelium_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/ed_sim/ed_sim_ref_clk_source/sim/common/xcelium_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/ed_synth/ed_synth_tg0_0/sim/common/xcelium_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/ed_sim/ed_sim_global_reset_n_source/sim/common/xcelium_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/ed_synth/ed_synth_hbm_0_example_design/sim/common/xcelium_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/ed_sim/ed_sim_core_clk_source/sim/common/xcelium_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/ed_sim/ed_sim_sim_checker/sim/common/xcelium_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/ed_synth/ed_synth_ninit_done_splitter/sim/common/xcelium_files.tcl]
source [file join [file dirname [info script]] ./../../../ip/ed_synth/ed_synth_core_clk_iopll/sim/common/xcelium_files.tcl]

namespace eval ed_sim {
  proc get_design_libraries {} {
    set libraries [dict create]
    set libraries [dict merge $libraries [ed_sim_hbm_only_reset_source::get_design_libraries]]
    set libraries [dict merge $libraries [ed_sim_mem::get_design_libraries]]
    set libraries [dict merge $libraries [ed_synth_reset_release_ip::get_design_libraries]]
    set libraries [dict merge $libraries [ed_synth_tg0_1::get_design_libraries]]
    set libraries [dict merge $libraries [ed_sim_ref_clk_source::get_design_libraries]]
    set libraries [dict merge $libraries [ed_synth_tg0_0::get_design_libraries]]
    set libraries [dict merge $libraries [ed_sim_global_reset_n_source::get_design_libraries]]
    set libraries [dict merge $libraries [ed_synth_hbm_0_example_design::get_design_libraries]]
    set libraries [dict merge $libraries [ed_sim_core_clk_source::get_design_libraries]]
    set libraries [dict merge $libraries [ed_sim_sim_checker::get_design_libraries]]
    set libraries [dict merge $libraries [ed_synth_ninit_done_splitter::get_design_libraries]]
    set libraries [dict merge $libraries [ed_synth_core_clk_iopll::get_design_libraries]]
  ...
  proc get_common_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR} {
    ...
    set design_files [dict merge $design_files [ed_sim_hbm_only_reset_source::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/ed_sim/ed_sim_hbm_only_reset_source/sim/"]]
    ...
    set design_files [dict merge $design_files [ed_synth_reset_release_ip::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/ed_synth/ed_synth_reset_release_ip/sim/"]]
    set design_files [dict merge $design_files [ed_synth_tg0_1::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/ed_synth/ed_synth_tg0_1/sim/"]]
    set design_files [dict merge $design_files [ed_sim_ref_clk_source::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/ed_sim/ed_sim_ref_clk_source/sim/"]]
    set design_files [dict merge $design_files [ed_synth_tg0_0::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/ed_synth/ed_synth_tg0_0/sim/"]]
    ...
    set design_files [dict merge $design_files [ed_synth_hbm_0_example_design::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/ed_synth/ed_synth_hbm_0_example_design/sim/"]]
    set design_files [dict merge $design_files [ed_sim_core_clk_source::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/ed_sim/ed_sim_core_clk_source/sim/"]]
    ...
    set design_files [dict merge $design_files [ed_synth_ninit_done_splitter::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/ed_synth/ed_synth_ninit_done_splitter/sim/"]]
    set design_files [dict merge $design_files [ed_synth_core_clk_iopll::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/ed_synth/ed_synth_core_clk_iopll/sim/"]]
    return $design_files
  }
  
  proc get_design_files {USER_DEFINED_COMPILE_OPTIONS USER_DEFINED_VERILOG_COMPILE_OPTIONS USER_DEFINED_VHDL_COMPILE_OPTIONS QSYS_SIMDIR} {
    set design_files [list]
    set design_files [concat $design_files [ed_sim_hbm_only_reset_source::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/ed_sim/ed_sim_hbm_only_reset_source/sim/"]]
    ...
    set design_files [concat $design_files [ed_synth_reset_release_ip::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/ed_synth/ed_synth_reset_release_ip/sim/"]]
    set design_files [concat $design_files [ed_synth_tg0_1::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/ed_synth/ed_synth_tg0_1/sim/"]]
    set design_files [concat $design_files [ed_sim_ref_clk_source::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/ed_sim/ed_sim_ref_clk_source/sim/"]]
    set design_files [concat $design_files [ed_synth_tg0_0::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/ed_synth/ed_synth_tg0_0/sim/"]]
    ...
    set design_files [concat $design_files [ed_synth_hbm_0_example_design::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/ed_synth/ed_synth_hbm_0_example_design/sim/"]]
    set design_files [concat $design_files [ed_sim_core_clk_source::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/ed_sim/ed_sim_core_clk_source/sim/"]]
    ...
    set design_files [concat $design_files [ed_synth_ninit_done_splitter::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/ed_synth/ed_synth_ninit_done_splitter/sim/"]]
    set design_files [concat $design_files [ed_synth_core_clk_iopll::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR/../../ip/ed_synth/ed_synth_core_clk_iopll/sim/"]]
    lappend design_files "xmvlog -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS  \"$QSYS_SIMDIR/ed_sim.v\"  -work ed_sim"
    return $design_files
  }
