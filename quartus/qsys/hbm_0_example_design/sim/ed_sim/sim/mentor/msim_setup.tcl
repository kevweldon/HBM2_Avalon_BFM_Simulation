...
append ELAB_OPTIONS [subst [ed_sim::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [ed_sim::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set normalized_src [ed_sim::normalize_path "$file"]
  set normalized_dest [ed_sim::normalize_path "$dest_file"]
...
if [string is false -strict [modelsim_ae_select $FORCE_MODELSIM_AE_SELECTION]] {
  ...
  ensure_lib                     ./libraries/fourteennm_hssi/    
  vmap       fourteennm_hssi     ./libraries/fourteennm_hssi/    
}
set design_libraries [dict create]
set design_libraries [dict merge $design_libraries [ed_sim::get_design_libraries]]
...
alias dev_com {
  ...
  if [string is false -strict [modelsim_ae_select $FORCE_MODELSIM_AE_SELECTION]] {
    ...
    eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QUARTUS_INSTALL_DIR/eda/sim_lib/ct1_hssi_atoms_ncrypt.sv"          -work fourteennm_hssi    
    eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QUARTUS_INSTALL_DIR/eda/sim_lib/ct1_hip_atoms_ncrypt.sv"           -work fourteennm_hssi    
    eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QUARTUS_INSTALL_DIR/eda/sim_lib/ct1_hssi_components.vhd"           -work fourteennm_hssi    
    eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QUARTUS_INSTALL_DIR/eda/sim_lib/ct1_hssi_atoms.vhd"                -work fourteennm_hssi    
    eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QUARTUS_INSTALL_DIR/eda/sim_lib/ct1_hip_components.vhd"            -work fourteennm_hssi    
    eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS        "$QUARTUS_INSTALL_DIR/eda/sim_lib/ct1_hip_atoms.vhd"                 -work fourteennm_hssi    
  }
...
alias com {
  ...
  set design_files [dict merge [ed_sim::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [ed_sim::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
