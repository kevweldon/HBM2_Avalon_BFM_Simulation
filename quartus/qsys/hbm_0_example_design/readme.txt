...
HBM IP. Files in this directory allow you to do the following:

1) Create a Quartus Prime project that instantiates an HBM
...
2) Create simulation projects for various supported simulators. The
   ...
   results as a way to understand the behavior of the HBM
...
sub-directory. For example, to run simulation using Synopsys' VCS, run:
   ...
   cd sim/ed_sim/sim/synopsys/vcs
   ./vcs_setup.sh
